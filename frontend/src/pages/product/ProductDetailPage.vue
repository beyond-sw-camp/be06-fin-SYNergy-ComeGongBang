    ...
    <div class="appContents" data-v-261d543d="">
      <div>
        <div class="ProductDetail" data-v-6da505b4="">
          ...
          <!-- 탭 -->
          <div
            class="BaseTabs BaseTabs__size--large BaseTabs__style--outline BaseTabs--width BaseTabs__border--top BaseTabs__border--bottom BaseTabs__align--left"
            style="--BaseTabs-item-length: 4; --BaseTabs-margin-x: 0" data-v-de0565e1="" data-v-6da505b4="">
            <div class="BaseTabs__inner" role="tablist" data-v-de0565e1="">
              <!--[-->
              <div class="BaseTab BaseTab--active" style="--BaseTab-width: 170" role="tab" border-top="true"
                border-bottom="true" data-v-47c662bd="" data-v-de0565e1="" v-for="(tab, index) in tabs" :key="index"
                @click="moveScroll(index)">
                <div class="BaseTab__contents" data-v-47c662bd="">
                  <div class="BaseFontVariable" data-v-9dbc8be1="" data-v-47c662bd="">
                    <div class="BaseFontVariable__text" data-v-9dbc8be1="">
                      ...
                      <span class="review-count-text">{{ tab.count }}</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <!-- 상품 상세 , 더보기 버튼-->
          <div class="ProductDetailDescription" :class="{ contract: !isInfoMoreOn }"
            style="--description-height: initial" data-v-6da505b4="" data-v-1d911075="">
            <!-- 상품 상세 정보 -->
            <div data-v-1d911075="">
              <a data-v-1d911075="">
                <div class="CoreImage" style="--image-height: initail" data-v-e62d27a4="" data-v-1d911075="">
                  <img data-v-e62d27a4="" src="https://cdn.idus.kr/static/common/images/20230619/004502_web_1120.jpg"
                    class="CoreImage__image" role="img" alt="" />
                  <div class="CoreImageDefault CoreImageDefault__display--none" style="--ids-image-default-size: 50%"
                    data-v-dfe5a850="" data-v-e62d27a4="">
                    <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="
                      ...
                      " class="BaseIcon CoreImageDefault__icon" data-v-6d2bd019="" data-v-dfe5a850="">
                      <path
              ...
              <div class="white--background" data-v-1d911075="">
                <div class="DescriptionNotice mt-[20px] mx-[16px] mb-[20px]" data-v-1d911075="" data-v-9757c483="">
                  <div class="DescriptionNotice__title" data-v-9757c483="">
                    ❤️필독!!확인부탁드립니다❤️
                  </div>
                  <div class="DescriptionNotice__contents" data-v-9757c483="">
                    배송일 지정시 꼭!! 발송일로 남겨주세요(평일기준) 주소변경 /
                    수량변경 시 주문취소후 재주문으로 부탁드려요 🙇🏻‍♀️ 00일발송 🆗
                    00배송 ❌
                  </div>
                </div>
                <div class="DescriptionNotice mt-[20px] mx-[16px] mb-[20px]" data-v-1d911075="" data-v-ab812ee6="">
                  <div class="DescriptionNotice__title" data-v-ab812ee6="">
                    안심하고 드세요!
                  </div>
                  <div class="DescriptionNotice__contents" data-v-ab812ee6="">
                    식품위생법에 따른 영업 신고, 등록을 하신 작가님이 판매하는
                    안전식품입니다.
                  </div>
                </div>
              </div>
              <div data-v-33a92dff="" data-v-1d911075="" class="ComponentQuote">
                <div data-v-bac4f2fe="" data-v-33a92dff="" class="BaseIconQuote" style="--quote-size: 24">
                  <div data-v-bac4f2fe="" class="BaseIconQuote__icon"></div>
                </div>
                <div data-v-33a92dff="" class="ComponentQuote__text">
                  ❤️발송일지정시 다른발송일을 선택하시면 같은날로 발송됩니다.
                  각각 다른발송일로 받으시려면 주문을 따로 주문주세요
                </div>
                <div data-v-bac4f2fe="" data-v-33a92dff="" class="BaseIconQuote BaseIconQuote__iconType--end"
                  style="--quote-size: 24">
                  <div data-v-bac4f2fe="" class="BaseIconQuote__icon"></div>
                </div>
              </div>
              <div data-v-6b4aad3c="" data-v-1d911075="" class="ComponentSubject">
                샤브레쿠키 / 초코칩쿠키 / 캐릭터머랭
              </div>
              <div data-v-d09d2e07="" data-v-1d911075="" class="ComponentImage">
                <div data-v-e62d27a4="" data-v-d09d2e07="" class="CoreImage" style="--image-height: initail">
                  <img data-v-e62d27a4=""
                    src="https://image.idus.com/image/files/9d095adb6e9b4385b6c0b9ae73abcaf7_720.jpg"
                    class="CoreImage__image" role="img" alt="" />
                  <div data-v-dfe5a850="" data-v-e62d27a4="" class="CoreImageDefault CoreImageDefault__display--none"
                    style="--ids-image-default-size: 50%">
                    <svg data-v-6d2bd019="" data-v-dfe5a850="" width="24" height="24" viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg" class="BaseIcon CoreImageDefault__icon" style="
                        width: 30%;
                        height: 30%;
                        opacity: 1;
                        fill: currentcolor;
                ...
                <div data-v-d09d2e07="" class="ComponentImage__label">
                  기본 샤브레 세트
                </div>
              </div>
              <div data-v-d09d2e07="" data-v-1d911075="" class="ComponentImage">
                <div data-v-e62d27a4="" data-v-d09d2e07="" class="CoreImage" style="--image-height: initail">
                  <img data-v-e62d27a4=""
                    src="https://image.idus.com/image/files/46cdeb425b174f2ca10f595edebb8d23_720.jpg"
                    class="CoreImage__image" role="img" alt="" />
                  <div data-v-dfe5a850="" data-v-e62d27a4="" class="CoreImageDefault CoreImageDefault__display--none"
                    style="--ids-image-default-size: 50%">
                    <svg data-v-6d2bd019="" data-v-dfe5a850="" width="24" height="24" viewBox="0 0 24 24"
              ...
              <div data-v-d09d2e07="" data-v-1d911075="" class="ComponentImage">
                <div data-v-e62d27a4="" data-v-d09d2e07="" class="CoreImage" style="--image-height: initail">
                  <img data-v-e62d27a4=""
                    src="https://image.idus.com/image/files/2f7c368fc7ca4cf39a8e0d61d6e42b5d_720.jpg"
                    class="CoreImage__image" role="img" alt="" />
                  <div data-v-dfe5a850="" data-v-e62d27a4="" class="CoreImageDefault CoreImageDefault__display--none"
                    style="--ids-image-default-size: 50%">
                    <svg data-v-6d2bd019="" data-v-dfe5a850="" width="24" height="24" viewBox="0 0 24 24"
              ...
              <div data-v-d09d2e07="" data-v-1d911075="" class="ComponentImage">
                <div data-v-e62d27a4="" data-v-d09d2e07="" class="CoreImage" style="--image-height: initail">
                  <img data-v-e62d27a4=""
                    src="https://image.idus.com/image/files/dd64afde76e9404d8d79bad27c91f1df_720.jpg"
                    class="CoreImage__image" role="img" alt="" />
                  <div data-v-dfe5a850="" data-v-e62d27a4="" class="CoreImageDefault CoreImageDefault__display--none"
                    style="--ids-image-default-size: 50%">
                    <svg data-v-6d2bd019="" data-v-dfe5a850="" width="24" height="24" viewBox="0 0 24 24"
              ...
              <div data-v-d09d2e07="" data-v-1d911075="" class="ComponentImage">
                <div data-v-e62d27a4="" data-v-d09d2e07="" class="CoreImage" style="--image-height: initail">
                  <img data-v-e62d27a4=""
                    src="https://image.idus.com/image/files/e678a1e99db94063808f9493bd1ec43d_720.jpg"
                    class="CoreImage__image" role="img" alt="" />
                  <div data-v-dfe5a850="" data-v-e62d27a4="" class="CoreImageDefault CoreImageDefault__display--none"
                    style="--ids-image-default-size: 50%">
                    <svg data-v-6d2bd019="" data-v-dfe5a850="" width="24" height="24" viewBox="0 0 24 24"
              ...
              <div data-v-d09d2e07="" data-v-1d911075="" class="ComponentImage">
                <div data-v-e62d27a4="" data-v-d09d2e07="" class="CoreImage" style="--image-height: initail">
                  <img data-v-e62d27a4=""
                    src="https://image.idus.com/image/files/bd4b85a513074504b11e0ec4c3efd7d5_720.jpg"
                    class="CoreImage__image" role="img" alt="" />
                  <div data-v-dfe5a850="" data-v-e62d27a4="" class="CoreImageDefault CoreImageDefault__display--none"
                    style="--ids-image-default-size: 50%">
                    <svg data-v-6d2bd019="" data-v-dfe5a850="" width="24" height="24" viewBox="0 0 24 24"
                ...
                <div data-v-d09d2e07="" class="ComponentImage__label">
                  샤브레+크로바곰 (108*80*60) 위에 옵션만 깨짐방지를 위해
                  용기가변경됩니다.
                </div>
              </div>
              <div data-v-33a92dff="" data-v-1d911075="" class="ComponentQuote">
              ...
              <div data-v-33a92dff="" data-v-1d911075="" class="ComponentQuote">
                ...
                <div data-v-33a92dff="" class="ComponentQuote__text">
                  📌📝수량 20개부터 스티커 가능합니다. 메세지 또는 요청사항에
                  문구를 남겨주세요~
                </div>
                <div data-v-bac4f2fe="" data-v-33a92dff="" class="BaseIconQuote BaseIconQuote__iconType--end"
                  style="--quote-size: 24">
              ...
              <div data-v-33a92dff="" data-v-1d911075="" class="ComponentQuote">
                ...
                <div data-v-33a92dff="" class="ComponentQuote__text">
                  발송일지정 지정발송일을 요청사항에 남겨주세요. 평일기준
                  1~2일소요되오니 여유있게 잡아주세요~ 발송일은
                  택배출발일입니다.
                </div>
                <div data-v-bac4f2fe="" data-v-33a92dff="" class="BaseIconQuote BaseIconQuote__iconType--end"
                  style="--quote-size: 24">
              ...
              <div data-v-8c526e1a="" data-v-1d911075="" class="ComponentText">
                ...
                있을수있으니 참고 꼭 부탁드려요 🙏
                ----------------------------------------- ❤ 하루의 즐거운 당충전
                ❤ 달콤상회디저트 예쁘게 맛있다~~!! 한번먹어보면 자꾸 생각나는
                입안이 행복해지는 수제쿠키 ✔맛구성 ❤샤브레쿠키 ❤ 바닐라 /
                초코아몬드/ 말차 ❤초코칩쿠키❤ ❤캐릭터머랭❤ ✔️메인사진외 금액별
                구성 가능하세요. 메시지로 상담가능합니다. ^^ ✔️포장상자크키 대략
                108*80*45 ✔️포장시사용하는 메세지카드/리본은 랜덤으로
                바뀔수있습니다.(재고소진시) ✔🚛우체국택배로 배송됩니다 🚚
                ✔쿠키의 크키는 수제작업으로인해 조금씩 크기가 약간씩
                틀릴수있어요. ✔꼼꼼히 포장하지만 배송중 약간의 깨짐이
                발생할수있어요 😢 깨짐으로인해 반품.환불은 불가입니다.
              </div>
            </div>
            <!-- 상품 더보기 버튼 -->
            <div style="" class="ProductDetailDescription__more" data-v-1d911075="" @click="handleInfoMoreOnOff">
              <button type="outline"
                ...
                style="
                  ...
                  font-weight: bold;
                  --button-rectangle-border-color: #505fcd;
                " data-v-524f63ea="" data-v-7940d6dd="" data-v-1d911075="">
                <!----><!--[--><svg data-v-6d2bd019="" data-v-524f63ea="" width="24" height="24" viewBox="0 0 24 24"
                  ...
                  :class="{ rotate: !isInfoMoreOn }" style="
                    width: 20px;
                    height: 20px;
                    opacity: 1;
                    fill: currentcolor;
                ...
                <div class="inline-flex items-center" data-v-524f63ea="">
                  <!--[--><!--]--><span class="CoreButton__text" data-v-524f63ea="">{{ infoMoreButtonCmt }}</span>
                </div>
                <!--]-->
              </button>
            </div>
          ...
          <!-- 유의사항 -->
          <div class="mt-[36px]" data-v-6da505b4="">
            <div data-v-6da505b4="">
              <div class="BaseSubHeader BaseSubHeader--clickable" style="
                ...
                <div class="BaseSubHeader__contents" data-v-b42a95d0="">
                  <!--[--><span class="subtitle3-bold-small">작품 정보제공 고시</span><!--]-->
                </div>
                <div class="BaseSubHeader__append" data-v-b42a95d0="">
                  <!--[--><svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="
                    ...
                    " class="BaseIcon" data-v-6d2bd019="">
              ...
              <div style="display: none" class="body1-regular-small pb-[16px]">
                <!--[-->
                <div class="body1-regular-medium mb-[10px] last:mb-0">
                  <div class="gray-999--text">포장단위별 용량(중량), 수량</div>
                  <div class="whitespace-pre-line">개별포장후 상자포장</div>
                </div>
                <div class="body1-regular-medium mb-[10px] last:mb-0">
                  <div class="gray-999--text">생산자 및 소재지</div>
                  <div class="whitespace-pre-line">
                    JJ달콤상회/충남 공주시 신관동 신금2길47 대아상가
                  </div>
                </div>
                <div class="body1-regular-medium mb-[10px] last:mb-0">
                  <div class="gray-999--text">원재료명 및 함량</div>
                  <div class="whitespace-pre-line">
                    샤브레:버터(영국)아몬드가루(미국산)계란(국산)아몬드슬라이스(미국)말차가루(일본)
                    모양쿠키:버터(영국)
                    아몬드가루(미국산)슈가파우더(미국,브라질)식용색소(미국)밀가루(미국)계란(국산)
                    초코칩쿠키:버터(영국)초코칩(싱가포르)밀가루(미국)계란(국산)
                  </div>
                </div>
                <div class="body1-regular-medium mb-[10px] last:mb-0">
                  <div class="gray-999--text">
                    제조연월일, 소비기한 또는 품질유지기한
                  </div>
                  <div class="whitespace-pre-line">작품상세표시</div>
                </div>
                <div class="body1-regular-medium mb-[10px] last:mb-0">
                  <div class="gray-999--text">관리법상 표시사항</div>
                  <div class="whitespace-pre-line">해당사항없음</div>
                </div>
                <div class="body1-regular-medium mb-[10px] last:mb-0">
                  <div class="gray-999--text">구성</div>
                  <div class="whitespace-pre-line">작품상세표시</div>
                </div>
                <div class="body1-regular-medium mb-[10px] last:mb-0">
                  <div class="gray-999--text">보관방법 또는 취급방법</div>
                  <div class="whitespace-pre-line">작품상세표시</div>
                </div>
                <div class="body1-regular-medium mb-[10px] last:mb-0">
                  <div class="gray-999--text">작품관련문의</div>
                  <div class="whitespace-pre-line">
                    하단의 "작품 문의" 버튼 선택
                  </div>
                </div>
            ...
            <hr class="BaseDivider" style="--border-color: #f5f5f5" data-v-6ef4cf18="" data-v-6da505b4="" />
            <div data-v-6da505b4="">
              <div class="BaseSubHeader BaseSubHeader--clickable" style="
                  --sub-header-padding-left: 0;
                  --sub-header-padding-right: 0;
                ...
                <!---->
                <div class="BaseSubHeader__contents" data-v-b42a95d0="">
                  <!--[--><span class="subtitle3-bold-small">제작 / 배송</span><!--]-->
                </div>
                <div class="BaseSubHeader__append" data-v-b42a95d0="">
                  <!--[-->
                  <div class="flex items-center body1_regular_small gray-666--text">
                    <div><span>평균 2일 / </span> 최대 3일 이내</div>
                    <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="
                        width: 20px;
                        height: 20px;
                        opacity: 1;
              ...
              <div style="display: none" class="body1_regular_medium pb-[16px] whitespace-pre-line">
                주문 후 제작에 들어가는 작품입니다.
              </div>
            </div>
            <hr class="BaseDivider" style="--border-color: #f5f5f5" data-v-6ef4cf18="" data-v-6da505b4="" />
            <div data-v-6da505b4="">
              <div class="BaseSubHeader BaseSubHeader--clickable" style="
                ...
                <!---->
                <div class="BaseSubHeader__contents" data-v-b42a95d0="">
                  <!--[--><span class="subtitle3_bold_small">교환 / 환불 / 반품</span><!--]-->
                </div>
                <div class="BaseSubHeader__append" data-v-b42a95d0="">
                  <!--[--><svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="
                      width: 20px;
              ...
              <div style="display: none" class="body1_regular_medium pb-[40px]">
                <!--[-->
                <div class="BaseDecorateText transform-gpu whitespace-pre-line inline" data-v-a1957620="">
                  <span class="DecorateText--bold DecorateText" style="
                      font-size: 14px;
                      color: #333333;
                      background-color: inherit;
                    " data-v-a1957620="">[반품/교환 배송비]<br /></span>
                </div>
                <div class="BaseDecorateText transform-gpu whitespace-pre-line inline" data-v-a1957620="">
                  <span class="DecorateText" style="
                      font-size: 14px;
                      color: #333333;
                      background-color: inherit;
                    " data-v-a1957620="">반품 : 편도 3,000원 / 왕복 6,000원 <br />교환 : 6,000원
                    <br />단순변심 및 고객님의 사유로 교환/반품하는 경우,
                    배송비는 고객님 부담입니다.<br />판매 작가님이 설정한
                    최소구매금액(1만 원)이 있는 경우, 고객님의 사유로
                    교환/반품하여 최소구매금액이 불충족될 시, 왕복 배송비는
                    고객님 부담입니다.<br />교환/반품하는 작품의 수량에 따라서
                    배송비는 추가 발생할 수 있습니다.<br />제주/도서산간 지역은
                    기본 배송비 외 추가 운임이 발생할 수 있습니다. 배송지역별
                    금액이 상이하므로 구매 전, 교환/반품 비용을 별도
                    문의하시기를 바랍니다. <br />교환/반품 조건(택배사, 배송비
                    부담, 반품 주소 등)을 반드시 작가님과 확인하고, 교환/반품
                    절차를 진행해 주시기를 바랍니다.<br /><br /><br /></span>
                </div>
                <div class="BaseDecorateText transform-gpu whitespace-pre-line inline" data-v-a1957620="">
                  <span class="DecorateText--bold DecorateText" style="
                      font-size: 14px;
                      color: #333333;
                      background-color: inherit;
                    " data-v-a1957620="">[교환/반품이 불가능한 경우]<br /></span>
                </div>
                <div class="BaseDecorateText transform-gpu whitespace-pre-line inline" data-v-a1957620="">
                  <span class="DecorateText" style="
                      font-size: 14px;
                      color: #333333;
                      background-color: inherit;
                    " data-v-a1957620="">• 반품가능기간(작품 수령후 7일 이내)이 지난 경우<br />•
                    고객님의 주문에 따라 개별적으로 생산되는 작품이 제작에
                    들어간 경우<br />• 고객의 사유로 작품 등이 전부 또는 일부가
                    멸실/훼손된 경우(단지, 작품 확인을 위한 포장 훼손 제외)<br />•
                    고객의 사용, 시간 경과, 소비에 의해 작품 등의 가치가 현저히
                    감소한 경우<br />• 시간의 경과에 의해 재판매가 곤란할 정도로
                    작품 등의 가치가 현저히 감소한 경우(신선 식품 등)<br />•
                    복제가 가능한 작품 등의 포장을 훼손되거나 디지털 콘텐츠 등의
                    제공이 개시된 경우<br /><br /><br /></span>
                </div>
                <div class="BaseDecorateText transform-gpu whitespace-pre-line inline" data-v-a1957620="">
                  <span class="DecorateText--bold DecorateText" style="
                      font-size: 14px;
                      color: #333333;
                      background-color: inherit;
                    " data-v-a1957620="">[작가님 교환/환불 안내]<br /></span>
                </div>
                <div class="BaseDecorateText transform-gpu whitespace-pre-line inline" data-v-a1957620="">
                  <span class="DecorateText" style="
                      font-size: 14px;
                      color: #333333;
                      background-color: inherit;
                    " data-v-a1957620="">주문 전 판매 작가님과 연락하여 확인해주세요.</span>
                </div>
                <div class="BaseDecorateText transform-gpu whitespace-pre-line inline" data-v-a1957620="">
                  <span class="DecorateText" style="
                      font-size: 14px;
                      color: #333333;
                      background-color: inherit;
                    " data-v-a1957620=""><br /><br />전자상거래 등에서의 소비자보호에 관한 법률에
                    의한 규정이 작가님이 제시한 조건보다 우선합니다.<br />단,
                    작가님이 제시한 조건이 관계법령보다 고객님께 유리한 경우에는
                    작가님의 제시 사항이 적용됩니다.<br /></span>
                </div>
                <!--]-->
              </div>
            </div>
          ...
          <div data-v-6da505b4="">
            <hr class="BaseDivider my-[36px]" style="--border-color: #d9d9d9" data-v-6ef4cf18="" data-v-6da505b4="" />
            <div class="BaseSubHeader" style="
                --sub-header-padding-left: 0;
                --sub-header-padding-right: 0;
                --sub-header-min-height: 56;
              " data-v-b42a95d0="">
              <div class="BaseSubHeader__contents" data-v-b42a95d0="">
                <span class="subtitle1_bold_small">작품 키워드</span>
              </div>
            </div>
            ...
            <div data-v-1903850c="" data-v-6da505b4="" class="flex flex-col w-full">
              <div data-v-1903850c="" class="flex w-full">
                ...
                <div data-v-1903850c="" class="flex flex-col items-start justify-start w-full ml-[8px] mt-[24px]">
                  <a data-v-1903850c="" href="https://www.idus.com/w/artist/5697b8a5-24fa-4ec9-87e1-feb61bc66e60"
                    rel="noopener noreferrer" class="flex items-center"><span data-v-1903850c=""
                      ...
                      <g data-v-1903850c="" clip-path="url(#clip0_124_2947)">
                        <path data-v-1903850c="" fill-rule="evenodd" clip-rule="evenodd"
                      ...
                      <defs data-v-1903850c="">
                        <clipPath data-v-1903850c="" id="clip0_124_2947">
                          <rect data-v-1903850c="" width="24" height="24"></rect>
                        </clipPath>
                      </defs>
                    </svg></a>
                  <div data-v-1903850c="" data-v-2c82c531="" class="BaseRating BaseRating__sizeText--medium mt-[6px]"
                    style="--BaseRating-gap: 0">
                    <div data-v-1903850c="" data-v-2c82c531="" class="BaseRating__rangeList">
                      <svg data-v-1903850c="" data-v-6d2bd019="" data-v-2c82c531="" width="24" height="24"
                        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                        class="BaseIcon CoreStar__type--full BaseRating__rangeListItem" style="
                          width: 14px;
                          height: 14px;
                          opacity: 1;
                          fill: currentcolor;
                      ...
                      </svg><svg data-v-1903850c="" data-v-6d2bd019="" data-v-2c82c531="" width="24" height="24"
                        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                        class="BaseIcon CoreStar__type--full BaseRating__rangeListItem" style="
                          width: 14px;
                          height: 14px;
                  ...
                  <div class="flex w-full mt-[16px] text-left" data-v-1903850c="">
              ...
              <div data-v-1903850c="">
                ...
                <div data-v-1903850c="" class="grid grid-cols-2 gap-x-[4px] pb-[16px]">
                  <div data-v-1903850c="" data-v-b6faa6c8=""
                    ...
                    <div data-v-1903850c="" data-v-b6faa6c8="" class="IDSTooltip__trigger">
                      <button data-v-1903850c="" data-v-524f63ea="" data-v-7940d6dd="" type="outline"
                        ...
                        ">
                        <svg data-v-1903850c="" data-v-6d2bd019="" data-v-524f63ea="" width="24" height="24"
                          viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="BaseIcon CoreButton__icon"
                          style="
                            width: 18px;
                            height: 18px;
                            opacity: 1;
                            ...
                            margin-right: 2px;
                          ">
                          <g data-v-1903850c="" clip-path="url(#clip0_124_2960)">
                            <path data-v-1903850c="" fill-rule="evenodd" clip-rule="evenodd"
                              d="M12.75 5V11.25H19V12.75H12.75V19H11.25V12.75H5V11.25H11.25V5H12.75Z"></path>
                          </g>
                          <defs data-v-1903850c="">
                            <clipPath data-v-1903850c="" id="clip0_124_2960">
                              <rect data-v-1903850c="" width="24" height="24"></rect>
                            </clipPath>
                          </defs>
                        </svg>
                        <div data-v-1903850c="" data-v-524f63ea="" class="inline-flex items-center">
                          <span data-v-1903850c="" data-v-524f63ea="" class="CoreButton__text">팔로우</span>
                        </div>
                      </button>
                    </div>
                  </div>
                  <button data-v-1903850c="" data-v-524f63ea="" data-v-7940d6dd="" data-v-9937b295="" type="outline"
                    class="CoreButton BaseButtonRectangle body1-regular-small BaseButtonRectangle__outline" style="
                      background-color: rgb(255, 255, 255);
                      color: rgb(51, 51, 51);
                      flex-direction: row;
                      --core-button-padding-x: 8;
          ...
          <div v-if="isVisible" @click="moveScroll(4)" class="TheFabContainer" data-v-6da505b4="" data-v-0397dfb3="">
            <!--[--><button type="button"
              class="CoreButton IdsButtonFab__size--medium IdsButtonFab__iconSize--medium IdsButtonFab TheMoveToTopFab__display--show mb-[12px]"
              style="
                background-color: rgb(255, 255, 255);
                color: rgb(51, 51, 51);
                height: 56px;
              ...
              " data-v-6da505b4="" data-v-524f63ea="" data-v-0b9311f9="" data-v-01e4f5dd="">
              <!----><!--[-->
...
export default {
  ...
  setup() {
    ...
    const moveScroll = (index) => {
      if (index === 1) {
        review.value?.scrollIntoView({ behavior: "smooth" });
      } else if (index === 2) {
        ask.value?.scrollIntoView({ behavior: "smooth" });
      } else if (index === 3) {
        atelier.value?.scrollIntoView({ behavior: "smooth" });
      } else if (index === 4) {

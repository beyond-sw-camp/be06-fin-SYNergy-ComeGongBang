        ...
        <div class="flex flex-col">
          ...
          <div class="flex justify-between mb-[80px]">
            <div class="w-[800px] mt-[16px] mr-[80px]">
              <div data-v-30a5f488="" class="DesktopPaymentPresentTaker mb-[36px]">
                <div data-v-b1bb0ef0="" data-v-30a5f488="" class="DesktopPaymentSection">
                  ...
                  <div data-v-b1bb0ef0="">
                    <div data-v-30a5f488="" class="DesktopPaymentPresentTaker__row mb-[16px] margin-top-16">
                      <div data-v-30a5f488="" class="DesktopPaymentPresentTaker__title">
                        <span data-v-30a5f488="" class="body1-regular-small gray-666--text">아이디</span>
                        <span data-v-30a5f488="" class="red-500--text ml-[4px]">*</span>
                      </div>
                      <div data-v-30a5f488="" class="DesktopPaymentPresentTaker__input">
                        <div data-v-6d6ea1ac="" class="BaseTextField__container" showerrormessage="true">
                          ...
                          <label data-v-6d6ea1ac="" class="BaseTextField BaseTextField--medium"><!---->
                            <input data-v-6d6ea1ac="" id="paymentPresentTakerPhone"
                                   name="paymentPresentTakerPhone"
                                   type="text" class="BaseTextField__input BaseTextField__input--left"
                                   placeholder="아이디를 입력해주세요"
                                   maxlength="20"
                                   v-model="toMemberEmail"><!---->
                            <button data-v-524f63ea="" data-v-778c1d9b="" data-v-6d6ea1ac="" type="button" class="CoreButton BaseButtonIcon BaseTextField__clearIcon" style="background-color: transparent; color: rgb(172, 172, 172); height: 20px; flex-direction: column; display: none;"><!---->
                              <svg data-v-6d2bd019="" data-v-524f63ea="" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="BaseIcon CoreButton__icon" style="width: 20px; height: 20px; opacity: 1; fill: currentcolor; --BaseIcon-color: #333333; margin-bottom: 0px;">
                                <g clip-path="url(#clip0_124_2957)">
                                  <path fill-rule="evenodd" clip-rule="evenodd" d="M12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2ZM15.4697 7.46967L11.9997 10.9397L8.53033 7.46967L7.46967 8.53033L10.9397 11.9997L7.46967 15.4697L8.53033 16.5303L11.9997 13.0597L15.4697 16.5303L16.5303 15.4697L13.0597 11.9997L16.5303 8.53033L15.4697 7.46967Z"></path>
                                </g>
                                <defs>
                                  <clipPath id="clip0_124_2957"><rect width="24" height="24"></rect></clipPath>
                                </defs>
                              </svg>
                    ...
                    <div data-v-30a5f488="" class="DesktopPaymentPresentTaker__divider"></div><!---->
                  </div>
                </div>
              </div>

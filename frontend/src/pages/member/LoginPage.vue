                              ...
                              <div class="col-start-4 col-span-6">
                                  ...
                                  <div class="pb-[48px]">
                                      <div data-v-41ff64ed="" class="grid-cols-1 gap-[0px] grid Login">
                                          ...
                                          <!-- 이메일 회원가입 -->
                                          <div>
                                              <router-link to="signup" data-v-524f63ea="" data-v-7940d6dd="" data-v-41ff64ed="" type="outline" class="CoreButton CoreButton--block BaseButtonRectangle subtitle3-bold-small BaseButtonRectangle__outline" style="background-color: rgb(255, 255, 255); color: rgb(51, 51, 51); height: 44px; flex-direction: row; --core-button-padding-x: 16; --button-rectangle-border-color: #acacac;">
                                                  <!---->
                                                  <!---->
                                                  <div data-v-524f63ea="" class="inline-flex items-center"><span data-v-524f63ea="" class="CoreButton__text">이메일로 가입하기</span></div>
                                              </router-link>
                                          </div>

  ...
  <body>
    <div id="__nuxt">
      <div class="appContainer" style="--container-width: 1040px; --app-bar-height: 0px;">
        <div data-v-26a5ae18="" class="TheContainer">
                ...
                <div class="col-start-4 col-span-6"><!---->
                  <div class="pb-[48px]">
                    <div data-v-41ff64ed="" class="grid-cols-1 gap-[0px] grid Login">
                      <div data-v-e70698af="" data-v-41ff64ed=""
                        class="BaseLogo BaseLogo__en BaseLogo__en--default BaseLogo__en--medium flex justify-self-center mt-[20px] mb-[8px] cursor-pointer">
                      </div> <!-- 로고 -->
                      <div data-v-41ff64ed="" tag="div" class="mb-[32px] text-center subtitle3-regular-medium"><span
                          data-v-41ff64ed="" class="Login__description px-[4px] subtitle3-bold-medium"><span
                            data-v-41ff64ed="" class="Login__descriptionText">로그인</span></span><span data-v-41ff64ed="">이
                          필요한 서비스입니다.</span></div>
                      <div data-v-343d1a74="" data-v-41ff64ed="" class="BaseTextSideBar mb-[12px]">
                      ...
                      </div><button data-v-524f63ea="" data-v-7940d6dd="" data-v-9f9341b7="" data-v-41ff64ed=""
                        type="fill"
                        class="CoreButton CoreButton--block BaseButtonRectangle subtitle3-bold-small BaseButtonRectangle__fill ButtonKakao kakao--background mb-[12px]"
                        style="background-color: rgb(239, 112, 20); color: rgb(255, 255, 255); height: 44px; flex-direction: row; --core-button-padding-x: 16;"><!----><svg
                          ...
                          <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M11.9994 3C7.01269 3 2.47021 6.33498 2.47021 10.4488C2.47021 13.0065 4.11991 15.2631 6.63257 16.6038L5.5753 20.5113C5.48212 20.8578 5.87231 21.1324 6.17249 20.9324L10.8066 17.8374C11.1978 17.8757 11.5954 17.8976 11.9994 17.8976C17.2629 17.8976 21.529 14.5626 21.529 10.4488C21.529 6.33498 17.2629 3 11.9994 3Z">
                          </path>
                        </svg>
                        <div data-v-524f63ea="" class="inline-flex items-center"><span data-v-524f63ea=""
                            class="CoreButton__text">카카오 3초만에 시작하기</span></div>
                      </button><button data-v-524f63ea="" data-v-7940d6dd="" data-v-41ff64ed="" type="outline"
                        ...
                        <div data-v-2b3ae965="">
                          <div data-v-6d6ea1ac="" class="BaseTextField__container" showerrormessage="true">
                            <div data-v-e2593c18="" data-v-6d6ea1ac="" class="BaseLabelText" style="display: none;"><span
                                data-v-e2593c18="" class="BaseLabelText__text"></span><!----></div><input
                              data-v-6d6ea1ac="" type="text" class="BaseTextField__hiddenInput" tabindex="-1"><label
                              data-v-6d6ea1ac="" class="BaseTextField BaseTextField--large"><!---->
                              
                              <!-- 이메일 작성 -->
                              <input v-model="member.email"
                                data-v-6d6ea1ac="" id="email" name="email" type="text"
                                class="BaseTextField__input BaseTextField__input--left" placeholder="이메일"><!---->
                                
                                <button
                                data-v-524f63ea="" data-v-778c1d9b="" data-v-6d6ea1ac="" type="button"
                                class="CoreButton BaseButtonIcon BaseTextField__clearIcon"
                                style="background-color: transparent; color: rgb(172, 172, 172); height: 24px; flex-direction: column; display: none;"><!---->
                                <svg
                                  data-v-6d2bd019="" data-v-524f63ea="" width="24" height="24" viewBox="0 0 24 24"
                                  xmlns="http://www.w3.org/2000/svg" class="BaseIcon CoreButton__icon"
                        ...
                        <div data-v-056d7ed4="" data-v-2b3ae965="">
                          <div data-v-1d2c5c78="" data-v-056d7ed4="" class="BaseTextFieldPassword">
                            <div data-v-6d6ea1ac="" data-v-1d2c5c78="" class="BaseTextField__container">
                              ...
                              </div><input data-v-6d6ea1ac="" type="text" class="BaseTextField__hiddenInput"
                                tabindex="-1"><label data-v-6d6ea1ac=""
                                class="BaseTextField BaseTextField--large"><!---->
                                
                                <!-- 비밀번호 입력 -->
                                <input v-model="member.password" data-v-6d6ea1ac="" id="password"
                                  name="password" type="password" class="BaseTextField__input BaseTextField__input--left"
                                  placeholder="비밀번호"><!---->
                                  <button data-v-524f63ea="" data-v-778c1d9b=""
                                  data-v-6d6ea1ac="" type="button"
                                  class="CoreButton BaseButtonIcon BaseTextField__clearIcon"
                                  style="background-color: transparent; color: rgb(172, 172, 172); height: 24px; flex-direction: column; display: none;"><!----><svg
                                    data-v-6d2bd019="" data-v-524f63ea="" width="24" height="24" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg" class="BaseIcon CoreButton__icon"
                                    style="width: 24px; height: 24px; opacity: 1; fill: currentcolor; --BaseIcon-color: #333333; margin-bottom: 0px;">
                                    <g clip-path="url(#clip0_124_2957)">
                                  ...
                                  <div data-v-524f63ea="" class="inline-flex items-center"><!----></div>
                                </button><button data-v-524f63ea="" data-v-778c1d9b="" data-v-6d6ea1ac="" type="button"
                                  class="CoreButton BaseButtonIcon ml-[8px]"
                                  style="background-color: transparent; color: rgb(102, 102, 102); height: 24px; flex-direction: column;"><!----><svg
                                    data-v-6d2bd019="" data-v-524f63ea="" width="24" height="24" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg" class="BaseIcon CoreButton__icon"
                                    style="width: 24px; height: 24px; opacity: 1; fill: currentcolor; --BaseIcon-color: #333333; margin-bottom: 0px;">
                      ...
                      <div data-v-2b3ae965="" class="mb-[8px]">
                        <div data-v-2b3ae965="" class="grid-cols-2 gap-[8px] grid"><label data-v-ee180726=""
                            data-v-2b3ae965="" for="save"
                            ...
                            <div data-v-ee180726="" class="BaseCheckbox__wrapper"><input data-v-ee180726="" id="save"
                                ...
                                class="BaseCheckbox__button"><svg data-v-6d2bd019="" data-v-ee180726="" width="24"
                                  ...
                                  style="width: 24px; height: 24px; opacity: 1; fill: currentcolor; --BaseIcon-color: #d9d9d9;">
                                ...
                                style="color: rgb(102, 102, 102);">이메일 저장하기</span></div>
                          </label>
                          <div data-v-2b3ae965="" class="text-right"><button data-v-524f63ea="" data-v-8493c3f2=""
                              data-v-2b3ae965="" type="default" class="CoreButton BaseButtonText body1-regular-small"
                              style="background-color: transparent; color: rgb(102, 102, 102); height: 32px; flex-direction: row-reverse; --core-button-padding-x: 8;"><!----><!---->
                              <div data-v-524f63ea="" class="inline-flex items-center"><span data-v-524f63ea=""
                                  class="CoreButton__text">아이디 / 비밀번호 찾기</span></div>
                            </button></div>
                        </div>
                      </div>
                      <div data-v-2b3ae965="">
                        ...
                        <!-- 로그인 버튼 -->
                        <button @click="login" data-v-524f63ea="" data-v-7940d6dd="" data-v-2b3ae965="" type="fill"
                          ...
                          <div data-v-524f63ea="" class="inline-flex items-center"><span data-v-524f63ea=""
                              class="CoreButton__text">로그인</span></div>
                        </button>
                      </div>
                    </div>
                  </div>

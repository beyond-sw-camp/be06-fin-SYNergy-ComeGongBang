                    ...
                    <div data-v-a5290452="" data-v-8fded032="" class="PageCartDesktop"
                        ...
                        <div data-v-a5290452="" class="PageCartDesktop__allCheck">
                            <div data-v-a5290452="" class="flex justify-start w-[1280px]">
                                <div data-v-a5290452=""
                                    ...
                                    <div><label data-v-ee180726=""
                                            class="BaseCheckbox BaseCheckbox__size--small BaseCheckbox__verticalAlign--center BaseCheckbox__state--checked my-[8px]"
                                            style="--BaseCheckbox--label-margin: 8;">
                                            <div data-v-ee180726="" class="BaseCheckbox__wrapper"><input
                                                    data-v-ee180726="" class="BaseCheckbox__input" type="checkbox"><span
                                                    data-v-ee180726="" class="BaseCheckbox__button"><svg
                                                        data-v-6d2bd019="" data-v-ee180726="" width="24" height="24"
                                                        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                                        class="BaseIcon BaseCheckbox__icon"
                                                        style="width: 24px; height: 24px; opacity: 1; fill: currentcolor; --BaseIcon-color: #ffffff;">
                                                    ...
                                                    style="color: rgb(51, 51, 51);">전체선택 (3/3개)</span></div>
                                        </label></div>
                        ...
                        <div data-v-a5290452="" class="flex justify-center mb-[30px]">
                            <div data-v-a5290452="" class="w-[850px] min-h-[550px]">
                                ...
                                <!-- 장바구니 작가 반복 -->
                                <div v-for="atelier in cartStore.cartList.atelierList" :key="atelier.atelierIdx"
                                    data-v-db78b45c="" data-v-a5290452="" class="CartArtist CartArtist--sticky"
                                    ...
                                    <div data-v-db78b45c="" class="CartArtist__header">
                                        <div data-v-db78b45c="" class="CartArtist__headerInner">
                                            <div data-v-db78b45c="" class="flex items-center justify-between h-[56px]">
                                                <div data-v-db78b45c="" class="flex items-center"><label
                                                        data-v-ee180726="" data-v-db78b45c=""
                                                        class="BaseCheckbox BaseCheckbox__size--small BaseCheckbox__verticalAlign--center BaseCheckbox__state--checked my-[8px] !w-auto inline-flex"
                                                        style="--BaseCheckbox--label-margin: 8;">
                                                        <div data-v-ee180726="" class="BaseCheckbox__wrapper"><input
                                                ...
                                                <div data-v-8cd67775=""
                                                    ...
                                                    <div data-v-8cd67775="" class="flex items-start">
                                                        <label data-v-ee180726="" data-v-8cd67775=""
                                                            class="BaseCheckbox BaseCheckbox__size--small BaseCheckbox__verticalAlign--center BaseCheckbox__state--checked !w-auto inline-flex"
                                                            style="--BaseCheckbox--label-margin: 8;">
                                                            <div data-v-ee180726="" class="BaseCheckbox__wrapper"><input
                                                                    data-v-ee180726="" class="BaseCheckbox__input"
                                                                    type="checkbox"><span data-v-ee180726=""
                                                                    ...
                                                                    <div data-v-6df967a0="" class="flex flex-col">
                                                                        <div data-v-6df967a0=""
                                                                            ...
                                                                            <div data-v-c2d3b141="" data-v-6df967a0=""
                                                                                ...
                                                                                </div><select data-v-c2d3b141=""
                                                                                    class="Count__select">
                                                                                    <option data-v-c2d3b141=""
                                                                                        class="Count__selectOption"
                                                                                        value="1">1</option>
                                                                                </select>
                                                                                <div data-v-c2d3b141=""
                                        ...
                                        <div data-v-db78b45c="">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="body1-bold-small">69,700원</div>
                                ...
                                <div data-v-adaf8eae="" data-v-a5290452="" class="CartPriceInfo">
                                    <div data-v-adaf8eae=""
                                        ...
                                        <div data-v-936440ee="" data-v-adaf8eae="" class="PriceInfo">
                                            <div data-v-936440ee="" class="py-[20px]">
                                                <div data-v-936440ee="" class="PriceInfo__item mb-[12px]">
                                                    ...
                                                    <div data-v-936440ee="" class="subtitle3_bold_small">81,400원</div>
                                                </div>
                                            ...
                                            <div data-v-936440ee="" class="PriceInfo__item py-[16px]">
                                                <div data-v-936440ee="" class="subtitle3-bold-small">총 3건 주문금액</div>
                                                <div data-v-936440ee="" class="flex flex-col items-end justify-center">
                                                    <div data-v-936440ee="" class="subtitle1-bold-small">81,400원</div>
                                                    <!---->
                                                </div>
                                            </div>
                                        </div><!---->
                                        <div data-v-adaf8eae="" class="flex justify-between w-full"><button
                                            ...
                                            </button><button data-v-524f63ea="" data-v-7940d6dd="" type="fill"

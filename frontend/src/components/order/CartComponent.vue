        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <div
                  v-if="props.pageType == 'cart'"
                  data-v-a5290452=""
                  class="headline4-bold-small"
                >
                  장바구니
                </div>

                <div
                  v-if="props.pageType == 'order'"
                  data-v-a5290452=""
                  class="headline4-bold-small"
                >
                  바로 구매하기
            ...
            >
              ...
              >
                ...
                <router-link
                  to="/"
                  data-v-58c5a73f=""
                  class="BaseEmptyStates__buttons"
                >
                  <button
                    data-v-524f63ea=""
                    data-v-7940d6dd=""
                ...
                <div data-v-a5290452="" class="w-[850px] min-h-[550px]">
                  ...
                  >
                    ...
                    <div data-v-db78b45c="" class="CartArtist__contents">
                            ...
                            >
                              ...
                              >
                                ...
                                <div v-else class="flex">
                                  ...
                                  <button
                                    @click="
                                      saveOrderMessage(product.productIdx)
                                    "
                                    data-v-524f63ea=""
                                    data-v-7940d6dd=""
                                    type="outline"
                      ...
                      <!-- 작가 더보기 -->
                      <router-link
                        :to="`/atelier/profile/${atelier.atelierIdx}`"
                        data-v-db78b45c=""
                      >
                        <hr
                          data-v-6ef4cf18=""

<template>
  <div id="__nuxt">
    <div class="appContainer" style="
          --mobile-fab-container-margin-bottom: 60px;
      ...
      <div
        ...
        <div class="flex-row flex w-desktop justify-between">
          ...
          <span v-else @mouseleave="upHere = false" class="flex body3-regular-small">
            ...
            <!-- 메세지 토글 -->
            <span class="w-[66px] relative flex justify-center items-center ml-[4px] gray-666--text"><button
                type="button" class="CoreButton BaseButtonIcon body3-regular-small" style="
                    background-color: transparent;
                    color: #666666;
                    height: 30px;
                ...
                <!----><!--[--><svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="
                      ...
                      margin-right: 4px;
                    " class="BaseIcon CoreButton__icon" data-v-6d2bd019="" data-v-524f63ea="">
                  <g clip-path="url(#clip0_124_2994)">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                          d="M20 3.19995C21.0544 3.19995 21.9182 4.01583 21.9945 5.05069L22 5.19995V17.2C22 18.2543 21.1841 19.1181 20.1493 19.1945L20 19.2H6.20711C6.10102 19.2 5.99841 19.2337 5.9136 19.2952L5.85355 19.3464L2.85355 22.3464C2.75979 22.4402 2.63261 22.4928 2.5 22.4928C2.25454 22.4928 2.05039 22.316 2.00806 22.0827L2 21.9928V5.19995C2 4.14559 2.81588 3.28179 3.85074 3.20544L4 3.19995H20ZM20 4.69995H4C3.75454 4.69995 3.55039 4.87683 3.50806 5.11008L3.5 5.19995V19.577L4.79289 18.2857C5.12629 17.9523 5.56528 17.7488 6.03125 17.7077L6.20711 17.7H20C20.2455 17.7 20.4496 17.5231 20.4919 17.2898L20.5 17.2V5.19995C20.5 4.95449 20.3231 4.75034 20.0899 4.70801L20 4.69995ZM7.5 9.94995C8.19036 9.94995 8.75 10.5096 8.75 11.2C8.75 11.8903 8.19036 12.45 7.5 12.45C6.80964 12.45 6.25 11.8903 6.25 11.2C6.25 10.5096 6.80964 9.94995 7.5 9.94995ZM12 9.94995C12.6904 9.94995 13.25 10.5649 13.25 11.2552C13.25 11.9456 12.6904 12.45 12 12.45C11.3096 12.45 10.75 11.8903 10.75 11.2C10.75 10.5096 11.3096 9.94995 12 9.94995ZM16.5 9.94995C17.1904 9.94995 17.75 10.5096 17.75 11.2C17.75 11.8903 17.1904 12.45 16.5 12.45C15.8096 12.45 15.25 11.8903 15.25 11.2C15.25 10.5096 15.8096 9.94995 16.5 9.94995Z">
                    </path>
                  </g>
                  <defs>
                    <clipPath id="clip0_124_2994">
                      <rect width="24" height="24"></rect>
                    </clipPath>
                  </defs>
                </svg>
                <div class="inline-flex items-center" data-v-524f63ea="">
                  <!--[--><!--]--><span class="CoreButton__text" data-v-524f63ea="">메시지</span>
                </div>
              <!--]-->
              </button><!----></span><!--]-->
      ...
      <div
          class="DesktopHeaderSearchBar z-desktop-header white--background w-full flex items-center justify-center sticky top-0 z-[1500]"
          data-v-4e58ad83="" data-v-8659a67b="">

        <div class="flex w-desktop justify-between h-full items-center white--background" data-v-8659a67b="">
          <div class="flex h-full items-center" data-v-8659a67b="">
            <div class="flex items-center justify-center w-[88px] cursor-pointer mr-[16px]" data-v-8659a67b="">
              <a aria-current="page" href="/v2/" class="router-link-active router-link-exact-active" data-v-8659a67b="">
                <div class="BaseLogo BaseLogo__en BaseLogo__en--default BaseLogo__en--small" data-v-e70698af=""
                     data-v-8659a67b=""></div>
              </a>
            </div>

            <div class="h-full" data-v-8659a67b="">
              <div class="flex w-[168px] px-[8px] mr-[10px] h-full items-center cursor-pointer" data-v-8659a67b=""><svg
                  width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                  style="width: 14px; height: 14px; opacity: 1; fill: currentcolor; --BaseIcon-color: #333333;"
                  class="BaseIcon" data-v-6d2bd019="" data-v-8659a67b="">
                <g clip-path="url(#clip0_124_2966)">
                  <path d="M3 6H21V4.5H3V6Z"></path>
                  <path d="M21 12.75H3V11.25H21V12.75Z"></path>
                  <path d="M21 19.5H3V18H21V19.5Z"></path>
                </g>
                <defs>
                  <clipPath id="clip0_124_2966">
                    <rect width="24" height="24"></rect>
                  </clipPath>
                </defs>
              </svg><span class="body1-bold-small ml-[10px] text-[15px] gray-333--text" data-v-8659a67b="">전체
                  카테고리</span></div>
                ...
                <div class="w-desktop flex min-h-[440px] pt-[12px]">
                  <div class="flex flex-col w-[220px]">
                    <div
                      ...
                      <div class="flex items-center body1-bold-small ml-[12px]">식품</div><svg data-v-6d2bd019=""
                                                                                             width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                                                                             class="BaseIcon mr-[13px]"
                                                                                             style="width: 24px; height: 24px; opacity: 1; fill: currentcolor; --BaseIcon-color: #ffc6a0;">
                    ...
                    <div
                      ...
                      <div class="flex items-center body1-bold-small ml-[12px]">패션/주얼리</div><!---->
                    </div>
                    <div
                        class="w-full h-[48px] flex flex-row items-center justify-between cursor-pointer gray-333--text rounded-[10px]">
                      <div class="flex items-center body1-bold-small ml-[12px]">홈리빙</div><!---->
                    </div>

                  </div>
                  <div class="white--background pl-[20px]">
                    <div class="flex flex-wrap items-start w-[1059px]">
                      <a href="/v2/category/shop/1"
                         class="flex items-center w-full subtitle3-bold-small ml-[10px] mt-[10px] mb-[12px] cursor-pointer gray-333--text hover:underline">
                        <div data-v-24b1dfb3="" class="BaseImage BaseImage__fixedWidth BaseImage__fixedHeight mr-[10px]"
                             style="--BaseImage-width: 36; --BaseImage-height: 36; --BaseImage-radius: 18;">
                          <div data-v-24b1dfb3="" class="BaseImage__image"
                               style="background-image: url(&quot;https://image.idus.com/image/files/424920cc31b04460a0406bcd4429170d.png&quot;);">
                            <img data-v-24b1dfb3=""
                                 src="https://image.idus.com/image/files/424920cc31b04460a0406bcd4429170d.png"
                                 class="hidden" loading="lazy">
                          </div>
                        </div> 식품관 바로가기 <svg data-v-6d2bd019="" width="24" height="24" viewBox="0 0 24 24"
                      ...
                      <div class="w-full grid grid-cols-5 auto-cols-max">
                        <!-- 디저트/음료 -->
                        <div class="flex flex-col w-[202px] w-full"><span
                            class="w-full shrink-0 p-[10px] flex items-center gray-ac--text caption1-bold-small">디저트/음료</span><a
                            href="/v2/category/1044"
                            class="w-full px-[12px] py-[8px] flex items-center gray-333--text body1-regular-small cursor-pointer shrink-0 hover:underline">전체</a><a
                            href="/v2/category/1068"
                            class="w-full px-[12px] py-[8px] flex items-center gray-333--text body1-regular-small cursor-pointer shrink-0 hover:underline">디저트/베이커리</a><a
                            href="/v2/category/1069"
                            class="w-full px-[12px] py-[8px] flex items-center gray-333--text body1-regular-small cursor-pointer shrink-0 hover:underline">떡/전통간식</a><a
                            href="/v2/category/1070"
                            class="w-full px-[12px] py-[8px] flex items-center gray-333--text body1-regular-small cursor-pointer shrink-0 hover:underline">초콜릿/사탕</a><a
                            href="/v2/category/1071"
                            class="w-full px-[12px] py-[8px] flex items-center gray-333--text body1-regular-small cursor-pointer shrink-0 hover:underline">음료/커피/차</a><a
                            href="/v2/category/1072"
                            class="w-full px-[12px] py-[8px] flex items-center gray-333--text body1-regular-small cursor-pointer shrink-0 hover:underline">전통주</a>
                        </div>
                        <!-- 수제 먹거리 -->
                        <div class="flex flex-col w-[202px] w-full"><span
                            class="w-full shrink-0 p-[10px] flex items-center gray-ac--text caption1-bold-small">수제먹거리</span><a
                            href="/v2/category/1045"
                            class="w-full px-[12px] py-[8px] flex items-center gray-333--text body1-regular-small cursor-pointer shrink-0 hover:underline">전체</a><a
                            href="/v2/category/1076"
                            class="w-full px-[12px] py-[8px] flex items-center gray-333--text body1-regular-small cursor-pointer shrink-0 hover:underline">건강식품</a><a
                            href="/v2/category/1073"
                            class="w-full px-[12px] py-[8px] flex items-center gray-333--text body1-regular-small cursor-pointer shrink-0 hover:underline">간편식/요리</a><a
                            href="/v2/category/1074"
                            class="w-full px-[12px] py-[8px] flex items-center gray-333--text body1-regular-small cursor-pointer shrink-0 hover:underline">식사대용</a><a
                            href="/v2/category/1075"
                            class="w-full px-[12px] py-[8px] flex items-center gray-333--text body1-regular-small cursor-pointer shrink-0 hover:underline">가공식품</a><a
                            href="/v2/category/1077"
                            class="w-full px-[12px] py-[8px] flex items-center gray-333--text body1-regular-small cursor-pointer shrink-0 hover:underline">김치</a><a
                            href="/v2/category/1078"
                            class="w-full px-[12px] py-[8px] flex items-center gray-333--text body1-regular-small cursor-pointer shrink-0 hover:underline">반찬</a><a
                            href="/v2/category/1079"
                            class="w-full px-[12px] py-[8px] flex items-center gray-333--text body1-regular-small cursor-pointer shrink-0 hover:underline">소스/장류</a>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div data-v-8659a67b="" data-v-8a32ee7e="">
              ...
              <div class="DesktopHeaderSearchInput" data-v-8a32ee7e="">
                <div class="BaseTextField__container DesktopHeaderSearchInput__input" data-v-6d6ea1ac=""
                     data-v-8a32ee7e="">
                  <div class="BaseLabelText" style="display: none" data-v-e2593c18="" data-v-6d6ea1ac="">
                    <span class="BaseLabelText__text" data-v-e2593c18=""></span><!---->
                  </div>
                  <input type="text" class="BaseTextField__hiddenInput" tabindex="-1" data-v-6d6ea1ac=""><label
                    class="BaseTextField BaseTextField--medium BaseTextField--outlined" data-v-6d6ea1ac=""><!----><input
                    value="" type="text" class="BaseTextField__input BaseTextField__input--left"
                    placeholder="[~83%] ‘추석선물’을 선물답게!" data-v-6d6ea1ac=""><!----><button type="button"
                                                                                         class="CoreButton BaseButtonIcon BaseTextField__clearIcon" style="
                          background-color: transparent;
                          color: #acacac;
                          height: 20px;
                          flex-direction: column;
                          display: none;
                        " data-v-524f63ea="" data-v-778c1d9b="" data-v-6d6ea1ac="">
                  ...
                  <!--]-->
                </button><button type="button" class="CoreButton BaseButtonIcon ml-[8px]" style="
                          background-color: transparent;
                          color: #666666;
                          height: 20px;
                          flex-direction: column;
                ...
                <div class="HeaderAutoComplete DesktopHeaderSearchInput__autoComplete" style="display: none"
                     data-v-8a32ee7e="" data-v-c791091c="">
                  <!--[--><!--]-->
                </div>
              </div>
              <!--]-->
            </div>
            <div data-v-ef695987="" data-v-8659a67b="" class="flex items-center relative ml-[12px] pl-[16px]">
              <div data-v-ef695987="" class="flex">
                <div data-v-8a88ccd0="" data-v-ef695987=""
                     class="flex justify-between items-center cursor-pointer HeaderKeywordItem--medium flex w-full">
                  <span data-v-8a88ccd0="" class="flex items-center px-[4px] py-[13px]"><span data-v-8a88ccd0=""
                                                                                              class="w-[20px] min-w-[20px] body1-bold-small gray-999--text">15</span><span data-v-8a88ccd0=""
                                                                                                                                                                           class="HeaderKeywordItem--medium__keyword flex black--text gray-333--text mx-[6px] line-clamp-1 flex-1">생일선물</span></span>
                </div>
                <div data-v-ef695987=""
                     class="shadow-[0_2px_4px_0_#d9d9d9] flex flex-col items-center bg-white py-[16px] px-[10px] DesktopHeaderKeywordRank__layer"
                     style="display: none">
                  <div data-v-de0565e1=""
                       class="BaseTabs BaseTabs__size--small BaseTabs__style--filled BaseTabs--width BaseTabs__border--bottom"
                       style="--BaseTabs-item-length: 2; --BaseTabs-margin-x: 0">
                    <div data-v-de0565e1="" class="BaseTabs__inner" role="tablist">
                      <div data-v-47c662bd="" data-v-de0565e1="" class="BaseTab" role="tab" border-top="false"
                           border-bottom="true" style="--BaseTab-width: 149">
                        <div data-v-47c662bd="" class="BaseTab__contents">
                          ...
                          <div data-v-9dbc8be1="" data-v-47c662bd="" class="BaseFontVariable">
                            <div data-v-9dbc8be1="" class="BaseFontVariable__text">
                              <span data-v-9dbc8be1="" class="BaseFontVariable__text--hidden">실시간 급상승</span><span
                                data-v-9dbc8be1="" class="BaseFontVariable__text--display">실시간 급상승</span>
                            </div>
                      ...
                      <div data-v-47c662bd="" data-v-de0565e1="" class="BaseTab BaseTab--active" role="tab"
                           border-top="false" border-bottom="true" style="--BaseTab-width: 149">
                        <div data-v-47c662bd="" class="BaseTab__contents">
                          <div data-v-47c662bd="" class="BaseTab__prefix"></div>
                          <div data-v-9dbc8be1="" data-v-47c662bd="" class="BaseFontVariable">
                            <div data-v-9dbc8be1="" class="BaseFontVariable__text">
                              <span data-v-9dbc8be1="" class="BaseFontVariable__text--hidden">인기 검색어</span><span
                                data-v-9dbc8be1="" class="BaseFontVariable__text--display">인기 검색어</span>
                            </div>
                            <span data-v-9dbc8be1="" class="flex-auto inline-flex items-center"></span>
                          </div>
                        </div>
                  ...
                  <div data-v-62649463="" class="grid grid-cols-2 pt-[10px]">
                    <div data-v-8a88ccd0="" data-v-62649463=""
                         class="flex justify-between items-center cursor-pointer HeaderKeywordItem--small px-[12px] w-[149px] h-[34px] overflow-hidden DesktopHeaderKeywordRankList__item">
                      <span data-v-8a88ccd0="" class="flex items-center px-[4px] py-[13px]"><span data-v-8a88ccd0=""
                                                                                                  class="w-[20px] min-w-[20px] body1-bold-small gray-999--text">1</span><span data-v-8a88ccd0=""
                                                                                                                                                                              class="HeaderKeywordItem--small__keyword flex black--text gray-333--text mx-[6px] line-clamp-1 flex-1">추석선물</span></span>
                    </div>
                    <div data-v-8a88ccd0="" data-v-62649463=""
                         class="flex justify-between items-center cursor-pointer HeaderKeywordItem--small px-[12px] w-[149px] h-[34px] overflow-hidden DesktopHeaderKeywordRankList__item">
                      <span data-v-8a88ccd0="" class="flex items-center px-[4px] py-[13px]"><span data-v-8a88ccd0=""
                                                                                                  class="w-[20px] min-w-[20px] body1-bold-small gray-999--text">2</span><span data-v-8a88ccd0=""
                                                                                                                                                                              class="HeaderKeywordItem--small__keyword flex black--text gray-333--text mx-[6px] line-clamp-1 flex-1">두바이초콜릿</span></span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="flex" data-v-8659a67b="">
            <div
                class="IDSTooltip__wrapper IDSTooltip__display--hide IDSTooltip__colorType--white IDSTooltip__innerPosition--bottom IDSTooltip__innerAlign--center IDSTooltip__innerCloseAlign--start ml-[20px]"
                style="
                  --ids-tooltip-width: 327px;
                  --ids-tooltip-full-left: --8px;
                " data-v-8659a67b="" data-v-b6faa6c8="">
              <div class="IDSTooltip__trigger" data-v-b6faa6c8="">
                <!--[-->
                <div class="BaseBadgeNotification__wrapper" data-v-cdfdef93="">
                  <!--[--><button type="button" class="CoreButton BaseButtonIcon caption1-regular-small rounded-[2px]"
                                  style="
                        background-color: transparent;
                        color: #333333;
                        height: 67px;
                  ...
                  <div data-v-cdfdef93=""
                       ...
                       style="
                        ...
                        right: 9px;
                      ">
                    <span data-v-cdfdef93=""><svg data-v-6d2bd019="" data-v-cdfdef93="" width="24" height="24"
                                                  viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="BaseIcon" style="
                            width: 8px;
                            height: 8px;
                            opacity: 1;
                            fill: currentcolor;
                          ...
                          ">
                        <path d="M16.616 3V13.968L7.256 3H5V20.736H8.504V9.864L17.696 20.736H20.12V3H16.616Z"></path>
                      </svg></span>
                  </div>
                </div>
                <!--]-->
      ...
      <div
          ...
          data-v-4e58ad83="" data-v-cc87a9e7="">
        <div
            ...
            style="--BaseTabs-item-length: 8; --BaseTabs-margin-x: 0" data-v-de0565e1="" data-v-cc87a9e7="">
          <div class="BaseTabs__inner" role="tablist" data-v-de0565e1="">
            <!--[-->
            <div class="BaseTab" style="--BaseTab-fontSize: 15; --BaseTab-fontWeight: 500" role="tab" border-top="false"
                 border-bottom="false" data-v-47c662bd="" data-v-de0565e1="">
              <div class="BaseTab__contents" data-v-47c662bd="">
                <div class="BaseTab__prefix" data-v-47c662bd="">
                  <!--[--><!--[-->
                  <div data-v-cc87a9e7="">
                    <div data-v-cc87a9e7="" class="lottie-animation-container lottie" autoplay="true" style="
                          --lottie-animation-container-width: 20px;
                          --lottie-animation-container-height: 20px;
                          --lottie-animation-container-background-color: transparent;
                          --lottie-animation-margin: 0 auto;
                        ">
                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                           viewBox="0 0 60 60" width="60" height="60" preserveAspectRatio="xMidYMid meet" style="
                            width: 100%;
                            height: 100%;

<template>
  <div id="__nuxt">
    ...
    >
      ...
      <div
        class="flex items-center justify-center w-full h-[30px] gray-f5--background z-desktop-header relative z-[1500]"
        data-v-4e58ad83=""
      >
        <div class="flex-row flex w-desktop justify-between">
          ...
          >
            ...
            <!-- 알림 토글 -->
            <span
              class="relative w-[55px] flex justify-center items-center ml-[4px] gray-666--text"
              ><button
                type="button"
                class="CoreButton BaseButtonIcon body3-regular-small"
                style="
                  background-color: transparent;
                  color: #666666;
                  height: 30px;
            ...
            <!-- 메세지 토글 -->
            <span
              class="w-[66px] relative flex justify-center items-center ml-[4px] gray-666--text"
              ><button
                type="button"
                class="CoreButton BaseButtonIcon body3-regular-small"
                style="
      ...
      <div
        class="DesktopHeaderSearchBar z-desktop-header white--background w-full flex items-center justify-center sticky top-[153px] z-[1500] z1500"
        data-v-4e58ad83=""
        data-v-8659a67b=""
      >
        <div
          class="flex w-desktop justify-between h-full items-center white--background"
          data-v-8659a67b=""
        >
          <div class="flex h-full items-center" data-v-8659a67b="">
            <div
              class="flex items-center justify-center w-[88px] cursor-pointer mr-[16px]"
              data-v-8659a67b=""
            >
              <a
                aria-current="page"
            ...
            <div class="h-full" data-v-8659a67b="">
              ...
              >
                ...
                <span
                  class="body1-bold-small ml-[10px] text-[15px] gray-333--text"
                  data-v-8659a67b=""
                  >전체 카테고리
                </span>
              </div>
            ...
            <div data-v-8659a67b="" data-v-8a32ee7e="">
              ...
              <div class="DesktopHeaderSearchInput" data-v-8a32ee7e="">
                <div
                  class="BaseTextField__container DesktopHeaderSearchInput__input"
                  data-v-6d6ea1ac=""
                  data-v-8a32ee7e=""
                >
                  <div
                ...
                <div
                  class="HeaderAutoComplete DesktopHeaderSearchInput__autoComplete"
                  style="display: none"
                  data-v-8a32ee7e=""
                  data-v-c791091c=""
                >
            ...
            <div
              data-v-ef695987=""
              data-v-8659a67b=""
              class="flex items-center relative ml-[12px] pl-[16px]"
            >
                  ...
                  <div data-v-62649463="" class="grid grid-cols-2 pt-[10px]">
                    ...
                    >
                      <span
                        ...
                        ><span
                          data-v-8a88ccd0=""
                          class="HeaderKeywordItem--small__keyword flex black--text gray-333--text mx-[6px] line-clamp-1 flex-1"
                          >추석선물</span
                        ></span
                      >
                    </div>
          ...
          <div class="flex" data-v-8659a67b="">
            <div
              ...
              style="--ids-tooltip-width: 327px; --ids-tooltip-full-left: --8px"
              data-v-8659a67b=""
              data-v-b6faa6c8=""
            >
                ...
                <div class="BaseBadgeNotification__wrapper" data-v-cdfdef93="">
                  ...
                  >
                    <span data-v-cdfdef93=""
                      ...
                      >
                        <path
                          d="M16.616 3V13.968L7.256 3H5V20.736H8.504V9.864L17.696 20.736H20.12V3H16.616Z"
                        ></path>
                      </svg>
                    </span>
                  </div>
            ...
            <div
              class="BaseBadgeNotification__wrapper ml-[8px]"
              data-v-8659a67b=""
              data-v-cdfdef93=""
            >
              <!--[-->
      ...
      <div
        class="DesktopHeaderMenuBar DesktopHeaderMenuBar--stickyHeader DesktopHeaderMenuBar--stickyHeaderMenu z-[1101]"
        data-v-4e58ad83=""
        data-v-cc87a9e7=""
      >
        <div
          ...
          style="--BaseTabs-item-length: 8; --BaseTabs-margin-x: 0"
          data-v-de0565e1=""
          data-v-cc87a9e7=""
        >
              ...
              <div class="BaseTab__contents" data-v-47c662bd="">
                <div class="BaseTab__prefix" data-v-47c662bd="">
                  ...
                  <div data-v-cc87a9e7="">
                    <div
                      data-v-cc87a9e7=""
                      class="lottie-animation-container lottie"
                      autoplay="true"
                      style="
...
export default {
  data() {
    return {
      isLogined: false,
      upHere: false,
      isCategoryVisible: false, // 클릭시 카테고리 컴포넌트 열림여부
    };
  },
  components: {
    HeaderCategoriesComponent,

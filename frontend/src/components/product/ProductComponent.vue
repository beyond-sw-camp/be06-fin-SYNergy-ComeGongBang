<template>
<div id="__nuxt">
    <div data-v-d1265ec2="" class="BaseProductCardVertical"
                  style="--product-card-round: 2; position: relative; overflow: hidden;">
                  <div data-v-eee6c6ce="" data-v-d1265ec2=""
                    ...
                    <div data-v-eee6c6ce="" class="BaseProductCardImage__image">
                      <div data-v-db6621f4="" data-v-eee6c6ce=""
                        class="CoreImageRatio__loadStatus--success CoreImageRatio" radius="2"
                        style="--ids-image-background: url(https://image.idus.com/image/files/37c9c62bdde744a0904e00e8706a170d_400.jpg); --ids-image-ratio: 1;">
                        <div data-v-db6621f4="" class="CoreImageRatio__image" role="img" alt=""
                          style="transform: scale(1);"></div>
                        <div data-v-dfe5a850="" data-v-db6621f4=""
                          class="CoreImageDefault CoreImageDefault__display--none"
                          style="--ids-image-default-size: 100%;"><svg data-v-6d2bd019="" data-v-dfe5a850="" width="24"
                      ...
                      <div data-v-f8c6bf35="" data-v-eee6c6ce=""
                        class="ProductCardFavorite BaseProductCardImage__favorite"
                        style="--product-card-favorite-size: 44;">
                        <span data-v-b1510e51="" data-v-f8c6bf35="" name="favorite_fill_shadow_p5" class="BaseIconColor BaseIconColor__favorite_fill_shadow_p5" style="--BaseIconColor-size: 28;"></span>
                      ...
                      <div data-v-eee6c6ce="" class="BaseProductCardImage__imageBottom"></div><!---->
                    </div>
                  </div>
                  <div data-v-87378e3e="" data-v-d1265ec2=""
                    ...
                    <div class="mt-[4px] mb-[8px]">
                      <div class="caption2-regular-small red-500--text pt-[4px] pb-[2px]">멤버십 회원 5% 추가할인</div>
                      <div class="flex flex-wrap items-end subtitle3-bold-small red-500--text">10,450<span
                          class="body3-regular-small mr-[4px]">원</span>
                        <div></div>
                      </div>
                    </div>
                    <div data-v-87378e3e="" class="BaseProductCardVerticalContents__reviewRate">
                      <div data-v-2c82c531="" data-v-87378e3e="" class="BaseRating BaseRating__sizeText--small"

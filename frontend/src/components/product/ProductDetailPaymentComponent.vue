<template>
  <div style="width: 390px">
    <div class="ATFArtist" data-v-1ef4b2e1="" style="width: 390px">
      <div class="ATFArtist__artist" data-v-1ef4b2e1="">
        <a href="https://www.idus.com/w/artist/5697b8a5-24fa-4ec9-87e1-feb61bc66e60" rel="noopener noreferrer"
          ...
          <div class="BaseAvatar mr-[4px]" style="
            ...
            <div class="CoreBadge BaseAvatar__iconDot" style="
              ...
              " data-v-8f163f81="" data-v-2fc5c54e="">
              <!--[--><!--]--><!---->
            </div>
            <div class="CoreBadge CoreBadge__position--bottom BaseAvatar__iconCamera" style="
        ...
        <div class="flex flex-col" data-v-1ef4b2e1="">
          <router-link :to="{ name: 'atelier', params: { idx: this.productStore.productDetail.atelierProfileInfoRes
                  .atelierIdx } }">
            <div class="flex" data-v-1ef4b2e1="">
              <span class="ATFArtist__artistName" data-v-1ef4b2e1="">{{
                this.productStore.productDetail.atelierProfileInfoRes
                  .atelierName
              }}</span><svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="
                  width: 16px;
                  height: 16px;
                  opacity: 1;
                  fill: currentColor;
                  --BaseIcon-color: #333333;
                " class="BaseIcon" data-v-6d2bd019="" data-v-1ef4b2e1="">
      ...
      <div class="w-[50%] text-right" data-v-1ef4b2e1="">
        <div class="ATFArtist__review" data-v-1ef4b2e1="">
          <div class="BaseRating BaseRating__sizeText--medium" style="--BaseRating-color: #505fcd; --BaseRating-gap: 0"
            data-v-2c82c531="" data-v-1ef4b2e1="">
    ...
    <div class="flex items-center justify-between headline5-regular-small py-[12px]">
      {{ this.productStore.productDetail.productName }}
      <div class="flex ml-[10px]" @click="toggleLike(this.productStore.productDetail.productIdx)">
        <button type="button" class="CoreButton BaseButtonIcon caption1-regular-small" style="
          ...
          <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="
              ...
              --BaseIcon-color: #333333;
              margin-bottom: 2px;
            " :class="productStore.productDetail.memberIsLike == false
        ...
        <div class="ml-[4px]">
          <div
            ...
            style="--ids-tooltip-full-left: --8px" data-v-b6faa6c8="">
            <div class="IDSTooltip__trigger" data-v-b6faa6c8="">
              <!--[--><!--[--><button type="button" class="CoreButton BaseButtonIcon caption1-regular-small" style="
                ...
                <div class="inline-flex items-center" data-v-524f63ea="">
                  <!--[--><!--]--><span class="CoreButton__text" data-v-524f63ea="">공유</span>
                </div>
                <!--]-->
              </button><!--]--><!--]-->
            </div>
    ...
    <div class="flex items-center justify-between mb-[12px]">
      <div class="leading-[1.2]" data-v-882bdf84="">
        <div class="mb-[4px] text-left" data-v-882bdf84="">
          <!--[-->
          <div class="BaseDecorateText transform-gpu whitespace-pre inline mr-[6px]" data-v-882bdf84=""
            data-v-a1957620="">
            <span class="DecorateText--strike DecorateText"
              style="font-size: 14px; color: #999999; background-color: inherit" data-v-a1957620="">{{
        ...
        <div class="flex items-center mb-[4px]" data-v-882bdf84="">
          <!--[-->
          <div class="BaseDecorateText transform-gpu whitespace-pre inline size22" data-v-882bdf84=""
            data-v-a1957620="">
            <span class="DecorateText--bold DecorateText"
              style="font-size: 22px; color: #ff4b50; background-color: inherit" data-v-a1957620="">{{
          ...
          <div class="BaseDecorateText transform-gpu whitespace-pre inline size22" data-v-882bdf84=""
            data-v-a1957620="">
            <span class="DecorateText--bold DecorateText"
              style="font-size: 22px; color: #333333; background-color: inherit" data-v-a1957620="">{{
    ...
    <div class="ProductDetailATFDiscountInfo mt-[16px] max-w-[580px]">
      <div class="border-[#e1e1e1] border-[1px] rounded-[8px] p-[14px] leading-[1.2] border-gray">
        <!----><!---->
        <div>
          <!--[-->
          <div class="flex justify-between body2-regular-small mb-[10px] last:mb-0">
            <div class="flex">
              <!----><!--[-->
              <div class="BaseDecorateText transform-gpu whitespace-pre-line line-clamp-1 text-ellipsis break-all"
                data-v-a1957620="">
                <span class="DecorateText" style="
                    font-size: 13px;
                    color: #333333;
                    background-color: inherit;
                  " data-v-a1957620="">작품 즉시할인</span>
              </div>
              <!--]-->
            </div>
            <!--[-->
            <div class="BaseDecorateText transform-gpu whitespace-pre inline ml-[8x] whitespace-nowrap"
              data-v-a1957620="">
              <span class="DecorateText" style="
                  font-size: 13px;
                  color: #333333;
    ...
    <div class="py-[20px]">
      <div class="mb-[20px]">
        <div class="OptionButton text-left border-gray" :class="{ 'toggle-on-background': isToggleOn }"
          data-v-7bf7483b="" @click="toggleOnOff">
          ...
          <svg data-v-6d2bd019="" data-v-7bf7483b="" width="24" height="24" viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg" class="BaseIcon min-w-[20px]" style="
              width: 20px;
              height: 20px;
              opacity: 1;
              fill: currentcolor;
        ...
        <div data-v-05d83f31="" class="DialogOption__container DialogOption__type--atf"
          ...
          <div data-v-05d83f31="" class="DialogOption">
            <div data-v-05d83f31="" class="DialogOption__contents">
              <div data-v-05d83f31="" class="">
                <div data-v-05d83f31="">
                  <div data-v-237a5614="" class="ProductOptionSelector mb-[8px] border-gray" v-for="(option, index) in this.productStore.productDetail
                    .productOptions" :key="index" @click="optionToggle(option.idx)">
                    <!-- selectedOptionIdx를 현재 선택한 idx로 초기화 -->
                    <div data-v-237a5614="" class="ProductOptionSelector__title" :class="{
                      ...
                      <div data-v-237a5614="" class="flex-auto whitespace-nowrap mr-[12px] text-left">
                        <!-- 옵션 대분류 - 번호.이름 -->
                        {{ index + 1 }}.{{ option.name }}
                      </div>
                      <div data-v-237a5614=""
                      ...
                      <svg data-v-6d2bd019="" data-v-237a5614="" width="24" height="24" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg" class="BaseIcon min-w-[20px]" style="
                          width: 20px;
                          height: 20px;
                          opacity: 1;
                    ...
                    <div :class="{
                      ...
                      <div v-for="subOption in option.subOptions" :key="subOption.idx"
                      ...
                      <hr data-v-6ef4cf18="" data-v-237a5614="" class="BaseDivider mx-[12px]"
        ...
        <div data-v-1d6c00b5="" class="SelectedItem mb-[8px]">
          <div data-v-1d6c00b5="" class="SelectedItem__info text-align-left">
            ...
            <div data-v-1d6c00b5="" class="w-[20px]" @click="deleteOption(option)">
              <svg data-v-6d2bd019="" data-v-1d6c00b5="" width="24" height="24" viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg" class="BaseIcon ml-[8px] cursor-pointer" style="
                  width: 20px;
                  height: 20px;
                  opacity: 1;
                  fill: currentcolor;
          ...
          <div data-v-1d6c00b5="" class="SelectedItem__tools">
            <div data-v-c2d3b141="" data-v-1d6c00b5="" class="Count">
              <!-- -버튼 -->
              <div @click="subOptionCount(option)" data-v-c2d3b141="" class="h-full border-r-[1px] border-[#f5f5f5]">
                <button data-v-524f63ea="" data-v-778c1d9b="" data-v-c2d3b141="" type="button"
                  class="CoreButton BaseButtonIcon gray-f5--background" style="
                    background-color: transparent;
                    height: 30px;
                    width: 30px;
                    flex-direction: column;
              ...
              <!-- +버튼 -->
              <div @click="addOptionCount(option)" data-v-c2d3b141="" class="h-full border-l-[1px] border-[#f5f5f5]">
                <button data-v-524f63ea="" data-v-778c1d9b="" data-v-c2d3b141="" type="button"
                  class="CoreButton BaseButtonIcon" style="
                    background-color: transparent;
                    color: rgb(51, 51, 51);
                    height: 30px;
                    width: 30px;
      ...
      <div>
        <div class="my-[16px]">
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center whitespace-pre-line body2-regular-small">
              <div data-v-a1957620="" class="BaseDecorateText transform-gpu whitespace-pre inline mr-[4px] last:mr-0">
            ...
            <div class="flex items-center ml-[10px]">
              <div class="flex items-center body3_regular_small gray-666--text cursor-pointer">
                총 작품금액
                <!---->
              </div>
              <!---->
    ...
    <div>
      <div class="grid grid-cols-2 gap-x-[6px]">
        <button type="outline"
          ...
          " data-v-524f63ea="" data-v-7940d6dd="" @click="addToCart">
          <!----><!--[--><!---->
          <div class="inline-flex items-center" data-v-524f63ea="">
        ...
        <router-link to="/">
          <button type="outline"
            ...
            <div class="inline-flex items-center" data-v-524f63ea="">
              <!--[--><!--]--><span class="CoreButton__text" data-v-524f63ea="">선물하기</span>
            </div>
          </button>
        </router-link>
      </div>
      <div class="mt-[5px]">
        <button type="fill"
          class="CoreButton CoreButton--block BaseButtonRectangle subtitle2-bold-small BaseButtonRectangle__fill" style="
            background-color: #ef7014;
            color: #ffffff;
            height: 48px;
            flex-direction: row;
            --core-button-padding-x: 16;
          " data-v-524f63ea="" data-v-7940d6dd="" @click="buyNow">
          <div class="inline-flex items-center" data-v-524f63ea="">
    ...
    <hr class="BaseDivider my-[8px]" style="--border-color: #f5f5f5" data-v-6ef4cf18="" />
  </div>
      ...
      <div class="flex items-center h-[18px] cursor-pointer">
        ...
        <div class="flex items-center justify-between w-full pl-[8px]">
          <div class="flex flex-wrap w-full">
            <!--[-->
            <div class="BaseDecorateText transform-gpu whitespace-pre inline" data-v-a1957620="">
              <span class="DecorateText" style="
                  font-size: 14px;
                  color: #333333;
                  background-color: inherit;
                " data-v-a1957620="">아이디어스는</span>
            </div>
            <div class="BaseDecorateText transform-gpu whitespace-pre inline" data-v-a1957620="">
            ...
            <div class="BaseDecorateText transform-gpu whitespace-pre inline" data-v-a1957620="">
              <span class="DecorateText__badge" data-v-a1957620=""><!---->
                <div class="BaseBadgeFreeShipping" style="--icon-width: 48; --icon-height: 18" data-v-a1957620=""
                  data-v-c3bdd300="">
                  <div class="BaseBadgeFreeShipping__icon" data-v-c3bdd300=""></div>
                </div>
              </span>
            </div>
            <!--]-->

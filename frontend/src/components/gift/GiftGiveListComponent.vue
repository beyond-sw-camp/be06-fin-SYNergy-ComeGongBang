  ...
  <div>
    <div class="flex items-start justify-between h-[40px] mb-[56px]">
      <div class="flex items-center">
        <p class="headline4-bold-small mr-[8px]">보낸 선물함</p>
        <svg
          data-v-6d2bd019=""
          width="24"
          height="24"
    ...
    <div>
      <GiftGiveComponent
        v-for="gift in giftStore.giftGiveList"
        :key="gift.idx"
        :gift="gift"
      />
      <!-- 선물이 없을 경우 -->
      <div v-if="giftStore.giftGiveList.length===0" data-v-58c5a73f="" class="BaseEmptyStates BaseEmptyStates__buttonStyle--full mt-[187px] mb-[80px]">
...
<script>
import GiftGiveComponent from "./GiftGiveComponent.vue";

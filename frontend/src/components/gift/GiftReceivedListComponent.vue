  ...
  <div>
    ...
    <div>
      <GiftReceivedComponent
        v-for="gift in giftStore.giftReceivedList"
        :key="gift.idx"
        :gift="gift"
      />
    </div>
    <!-- 선물이 없을 경우 -->
    <div
      v-if="giftStore.giftReceivedList.length === 0"
      data-v-58c5a73f=""
      class="BaseEmptyStates BaseEmptyStates__buttonStyle--full mt-[187px] mb-[80px]"
    >

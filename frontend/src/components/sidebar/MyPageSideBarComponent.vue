  ...
  <div class="MyPageSideBar">
    <div data-v-095dc081="" class="MyPageSidebarDesktop w-[180px]">
      ...
      <div data-v-095dc081=""
        ...
        <!-- 프로필이미지 -->
        <label data-v-b4eb4e33="" for="profileImageInput" class="MyProfileImageUploader group" :style="`--profile-image: url(${memberStore.member.profileImageUrl ||
        ...
        <div class="flex justify-center align-middle mt-[20px]">
          <img src={{memberStore.member.gradeImageUrl}} width="24" height="24" class="flex my-auto" /><button
            data-v-524f63ea="" data-v-8493c3f2="" type="default"
            class="CoreButton BaseButtonText body1-regular-small !pr-0" style="
      ...
      <p data-v-095dc081="" class="block px-[16px] py-[9px] text-white bg-[#ff7b30] body1-bold-medium">
        MY MENU
      </p>
      <!---------------------------사이드바 하단 목록------------------------------------->
      ...
      <nav data-v-095dc081="" class="bg-[#fbfafa]">
        ...
        <div data-v-095dc081="" class="border-solid border-b border-[#efe8e6] last:border-b-0 py-[11px] px-[16px]">
          ...
          <router-link to="/order-list" data-v-095dc081="">
            <div data-v-095dc081="" class="flex flex-col">
              <span data-v-095dc081="" class="body3-regular-small MyPageSidebarDesktop__menu">주문/배송 내역</span>
            </div>
          </router-link>
        </div>
        <!---------------------알림-------------------------->
        <div data-v-095dc081="" class="border-solid border-b border-[#efe8e6] last:border-b-0 py-[11px] px-[16px]">
          ...
          <div data-v-095dc081="">
            <router-link to="/TODO" data-v-095dc081="" class="flex flex-col">
              <span data-v-095dc081="" class="body3-regular-small MyPageSidebarDesktop__menu">
                알림
              </span>
            </router-link>
          </div>
        ...
        <!---------------------나의 구매후기-------------------------->
        <div data-v-095dc081="" class="border-solid border-b border-[#efe8e6] last:border-b-0 py-[11px] px-[16px]">
          <span data-v-095dc081="" class="body2-bold-medium">나의 구매후기</span>
          <div data-v-095dc081="" v-for="item in ReviewItems" :key="item.id"
            :class="[{ 'bg-active': activeTab === item.path }]">
            <div data-v-095dc081="">
              <router-link :to="item.path" @click="setActiveTab(item.id)" class="flex flex-col">
                <span data-v-095dc081="" class="body3-regular-small MyPageSidebarDesktop__menu">
                  {{ item.subLabel }}
                </span>
              </router-link>
        ...
        <div data-v-095dc081="" class="border-solid border-b border-[#efe8e6] last:border-b-0 py-[11px] px-[16px]">
          ...
          <div data-v-095dc081="" v-for="item in menuItems" :key="item.id"
            :class="[{ 'bg-active': activeTab === item.path }]">
            <div data-v-095dc081="">
              <router-link :to="item.path" @click="setActiveTab(item.id)" class="flex flex-col">
                <span data-v-095dc081="" class="body3-regular-small MyPageSidebarDesktop__menu">
        ...
        <div data-v-095dc081="" class="border-solid border-b border-[#efe8e6] last:border-b-0 py-[11px] px-[16px]">
          ...
          <div data-v-095dc081="">
            <router-link to="/grade" data-v-095dc081="" class="flex flex-col">
              <span data-v-095dc081="" href="" class="body3-regular-small MyPageSidebarDesktop__menu">
                회원 등급
              </span>
            </router-link>
            <router-link to="/update/member-info" data-v-095dc081="" class="flex flex-col">
              <span data-v-095dc081="" href="https://www.idus.com/v2/mypage/edit-user-info"
                class="router-link-active router-link-exact-active body3-regular-small MyPageSidebarDesktop__menu"
                aria-current="page">
                회원 정보 관리
              </span>
            </router-link>
            <router-link to="/deliveryAddress" data-v-095dc081="" class="flex flex-col">
              <span data-v-095dc081=""
                class="router-link-active router-link-exact-active body3-regular-small MyPageSidebarDesktop__menu"
                aria-current="page">
                배송지 관리
              </span>

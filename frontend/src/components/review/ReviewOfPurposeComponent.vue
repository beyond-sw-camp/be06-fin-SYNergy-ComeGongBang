<template>
    <div class="PageFavoriteListDesktop w-full pl-6">
        ...
        <!-----------------------------------------탭 부분------------------------------------------------------->
        <div class="BaseTabs BaseTabs__size--large BaseTabs--full BaseTabs__style--filled BaseTabs__border--bottom BaseTabs__align--left"
            style="--BaseTabs-item-length: 2; --BaseTabs-margin-x: 0" data-v-de0565e1="">
            <div class="BaseTabs__inner" role="tablist" data-v-de0565e1="">
                ...
                ]" style="" border-top="false" border-bottom="true" data-v-47c662bd="" data-v-de0565e1="" role="tab"
                    ...
                    <div class="BaseTab__contents" data-v-47c662bd="">
                        ...
                        <div class="BaseFontVariable" data-v-9dbc8be1="" data-v-47c662bd="">
                            <div class="BaseFontVariable__text" data-v-9dbc8be1="">
                                <span class="BaseFontVariable__text--hidden" data-v-9dbc8be1="">{{ tab.title
                                    }}</span><span class="BaseFontVariable__text--display" data-v-9dbc8be1="">{{
                                        tab.title }}</span>
                            </div>

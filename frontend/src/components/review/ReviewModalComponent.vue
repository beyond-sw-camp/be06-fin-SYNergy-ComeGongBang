          ...
          <div>
            <div class="ProductDetail" data-v-6da505b4="">
              <div class="flex pb-[40px]" data-v-6da505b4="">
                <div
                  class="min-w-[680px] w-[680px] mt-[16px]"
                  data-v-6da505b4=""
                >
                      ...
                      >
                        ...
                        >
                          ...
                          <div data-v-60bedabc="" class="BaseDialog__contents">
                            ...
                            <div
                              data-v-60bedabc=""
                              class="BaseDialog__contentsInner"
                            >
                              <!---->
                              <div class="pb-[16px]">
                                <div class="flex flex-row px-[16px] py-[8px]">
                                  <div class="w-[60px] h-[60px] shrink-0">
                                    ...
                                    >
                                      <div
                                        data-v-eee6c6ce=""
                                        class="BaseProductCardImage__image"
                                      >
                                        <div
                                          data-v-db6621f4=""
                                          data-v-eee6c6ce=""
                                  ...
                                  <div class="pl-[8px] flex-grow">
                                    ...
                                    <div
                                      class="flex flex-row align-center items-end"
                                    >
                                      <div
                                ...
                                />
                                <div
                                  class="flex flex-col items-center p-[16px]"
                                >
                                  <div
                                ...
                                <div class="p-[16px]">
                                  ...
                                  <div class="mt-[8px]">
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        >
                                          ...
                                          >
                                            <g
                                              clip-path="url(#clip0_6644_26666)"
                                            >
                                              <path
                                                fill-rule="evenodd"
                                                clip-rule="evenodd"
                                    ...
                                    >
                                      <li>
                                        사진은 jpg, jpeg, png 형식으로 6개까지
                                        등록가능합니다.
                                      </li>
                                      <li>
                                        등록된 사진은 드래그하면 순서 변경이
                                        되고, 클릭하면 삭제할 수 있습니다.
                                      </li>
                                    </ul>
                                  </div>
                                  <h5 class="body1_bold_small mt-[16px]">
                                    텍스트 후기
                                  </h5>
                                  <div
                                    data-v-be77401d=""
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      >
                                        <span data-v-612abd8a=""
                                          >{{ reviewText.length }}/1000</span
                                        >
                                      </div>
                                    </div>
                                  </div>
                          ...
                          >
                            <div
                              data-v-60bedabc=""
                              class="grow BaseDialog__footerWrapper"
                            >

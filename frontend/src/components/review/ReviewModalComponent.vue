      ...
      <div class="appContainer" style="
        ...
        <div class="IDSTooltip__trigger" data-v-b6faa6c8="">
          ...
          <button @click="openModal" type="outline"
            class="CoreButton BaseButtonRectangle subtitle3-bold-small BaseButtonRectangle__outline" style="
            ...
            --button-rectangle-border-color: #ef7014;
                " data-v-524f63ea="" data-v-7940d6dd="" data-v-14aa7a1c="">
            <!----><!--[--><!---->
            <div class="inline-flex items-center" data-v-524f63ea="">
              <!--[--><!--]-->
              <span class="CoreButton__text" data-v-524f63ea="">후기 작성하기
              </span>
            </div>
            <!--]-->
          </button>
                      ...
                      <div data-v-60bedabc="" class="BaseDialog flex justify-center items-center fixed top-0 left-0"
                        ...
                        <div data-v-60bedabc="" class="BaseDialog__wrapper--medium--basic BaseDialog__container"
                          ...
                          <div data-v-899a28fb="" data-v-60bedabc="">
                            <div data-v-899a28fb="" class="BaseCommonHeader w-full flex justify-center items-center">
                              <span data-v-899a28fb=""
                                class="BaseCommonHeader__slot flex shrink-0 items-center justify-center grow-0 mx-[8px]"><span
                                  ...
                                  <!-- X 버튼 -->
                                  <button @click="closeModal" data-v-524f63ea="" data-v-778c1d9b="" data-v-60bedabc=""
                                    type="button" class="CoreButton BaseButtonIcon"
                              ...
                              <span data-v-899a28fb="" class="flex items-center grow">
                                <span data-v-899a28fb=""
                                  class="subtitle3-bold-small grow gray-333--text text-center break-all line-clamp-1">후기
                                  작성</span>
                              </span>
                              <span data-v-899a28fb=""
                            ...
                            <div data-v-60bedabc="" class="BaseDialog__contentsInner"><!---->
                              <div class="pb-[16px]">
                                      ...
                                      <div data-v-eee6c6ce="" class="BaseProductCardImage__image">
                                        <div data-v-db6621f4="" data-v-eee6c6ce=""
                                          ...
                                          <div data-v-dfe5a850="" data-v-db6621f4=""
                                            ...
                                            <svg data-v-6d2bd019="" data-v-dfe5a850="" width="24" height="24"
                                              viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                  ...
                                  <div data-v-2c82c531=""
                                    ...
                                    <div data-v-2c82c531="" class="BaseRating__rangeList">
                                      <div v-for="(star, idx) in stars" :key="idx" @click="starCheck(idx + 1)">
                                        <svg v-if="idx < rating" data-v-6d2bd019="" data-v-2c82c531="" width="24"
                                        ...
                                        <svg v-else data-v-6d2bd019="" data-v-2c82c531="" width="24" height="24"
                                          viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div class="p-[16px]">
                                  ...
                                  <!-- 후기 이미지 업로드 버튼 -->
                                  <div class="mt-[8px]">
                                    <input data-v-503775b4="" id="imageUploader" type="file" name="imageUploader"
                                      accept="image/jpeg, image/png" class="ImageUploader__input" @change="imageUpload"
                                      multiple />
                                  ...
                                  <div data-v-be77401d=""
                                    ...
                                    <!-- 후기 내용 작성칸 -->
                                    <textarea v-model="reviewText" data-v-be77401d="" placeholder="최소 15자 이상 작성해주세요."
                                      maxlength="1000" class="BaseTextarea__textarea"></textarea>
                          ...
                          <div data-v-60bedabc=""
                            ...
                            <div data-v-60bedabc="" class="grow BaseDialog__footerWrapper">
                              <div class="flex justify-center">
                                ...
                                <button data-v-524f63ea="" data-v-7940d6dd="" type="fill"

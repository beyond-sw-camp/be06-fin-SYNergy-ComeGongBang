<template>
  <div class="gray-f5--background p-[16px] rounded-[8px] mt-[12px]">
    <div>
      <div
        data-v-a1957620=""
    ...
    <div class="body3_regular_small mt-[4px]">
      <div
        data-v-a1957620=""
        class="BaseDecorateText transform-gpu whitespace-pre inline"
      >
  ...
  >
    <div
      data-v-14aa7a1c=""
      class="flex justify-between pb-[8px] border-b border-[#f5f5f5]"
    >
      <div data-v-14aa7a1c="" class="flex items-center">
        <div
          data-v-a1957620=""
          data-v-14aa7a1c=""
          class="BaseDecorateText transform-gpu whitespace-pre inline mr-[8px] DesktopWritableReviewItem__dueDate"
        >
          <span
            data-v-a1957620=""
            class="DecorateText DecorateText--bold"
        ...
        <div data-v-14aa7a1c="" class="subtitle3-regular-small gray-666--text">
          24.10.10 까지
        </div>
      </div>
